    ...
    //console.log("Challenge (%s) and Section (%s)",Num,Section)
        if(Num==1)
            {
                 ...
                 if(Section==0)
                    {
                        ...
                        document.getElementById("Category_box4").innerHTML ='<i class="fas fa-search" id="Cat3_search" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="search"></i>';
                        ...
                        $('#Challenge1_Text0').css('visibility','visible');
                        $('#Challenge1_Text0').css('display','block');
                        ...
                        document.getElementById("challenge_btn").innerHTML ="CONTINUE";
                    }
                else if(Section==1)
                    {
                        
                        $('#Challenge1_Text0').css('visibility','hidden');
                        $('#Challenge1_Text0').css('display','none');
                ...
                else if (Section==3)
                    {
                        ...
                        document.getElementById("Type_Of_Star").innerHTML ="a different type of star (an M star—but again, don’t worry about what the letter means).";
                        document.getElementById("Type_Of_StarName").innerHTML ="<i>M</i> star";
                ...
                document.getElementById('Targets1Filters').innerHTML='<option value="">M Star</option>';
                ...
                else if (Section==4)
                    {
                        ...
                        document.getElementById("Type_Of_Star").innerHTML ="a different type of star (a B star—but again, don’t worry about what the letter means).";
                        document.getElementById("Type_Of_StarName").innerHTML ="<i>B</i> star";
        ...
        /*=======================================*/
        else if(Num==3)
            {
                ...
                document.getElementById('Targets1Filters').innerHTML='<option value="">Earth</option>';
        ...
        /*=======================================*/
        else if(Num==4)
            {
                ...
                $('#Challenge4_Text2').css('visibility','hidden');
                $('#Challenge4_Text2').css('display','none');
                $('#Challenge4_Text3').css('visibility','hidden');
                $('#Challenge4_Text3').css('display','none');
                $('#LowerGraphRow').css('visibility','visible');
                /*=======================================*/
                SeacrhFor('Lamps','Category1');
                document.getElementById("Category_box3").innerHTML ="<i class=\"fab fa-medapps\" id=\"Cat1_Lamps\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Lamps\"></i>";
                ...
                if(Section==1)
                ...
                else if(Section==2)
                    {
                        ...
                        document.getElementById("Comparison_Name").innerHTML ="";
                        //document.getElementById("Target_Name").innerHTML ="Vaper Metal_Halide_Bulb";
                        ...
                        document.getElementById("Comparison_Name").innerHTML ="";
                        document.getElementById('LowerImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";
                        document.getElementById('Targets1Filters').innerHTML='<option value="">Metal Halide</option>';
                        $('#Challenge4_Text1').css('display','none');
                        $('#Challenge4_Text2').css('visibility','visible');
                        $('#Challenge4_Text2').css('display','block');
                        $("#challenge_btn").attr("onclick","ShowChallenge(4,3)");
                        document.getElementById("challenge_btn").innerHTML ="CONTINUE";
                    }
                else if(Section==3)
                    {
                        ...
                        document.getElementById("Comparison_Name").innerHTML ="";
                        document.getElementById('LowerImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";
                        document.getElementById('Targets1Filters').innerHTML='<option value="">Vaper Lamp</option>';
                        $('#Challenge4_Text1').css('display','none');
                        $('#Challenge4_Text2').css('visibility','hidden');
                        $('#Challenge4_Text2').css('display','none');
                        $('#Challenge4_Text3').css('visibility','visible');
                        $('#Challenge4_Text3').css('display','block');
        ...
        else if(Num==5)
            {
                ...
                if(Section==1)
                    {                        
                        ...
                        SeacrhFor('Thermal_Spectra','Category2');                
                        document.getElementById("Category_box4").innerHTML ="<i class=\"fas fa-thermometer-three-quarters\" id=\"Cat1_Thermal_Spectra\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Thermal_Spectra\"></i>";
