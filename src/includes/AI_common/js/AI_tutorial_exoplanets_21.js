...
function NextSlide(Choice,pick) 
	{
		...
		switch(Choice){
          ...
          case "third":
                ...
                document.getElementById('Targets0Filters').innerHTML='<option value="Exoplanet_Models">Exoplanet Models</option>';
                SelectTarget('Clear_Hot_Jupiter_Model_Transmission','Targets1');
                /*=======================================*/
                document.getElementById('Targets1Filters').innerHTML='<option id="Clear_Hot_Jupiter_Model_Transmission_Category1" value="Clear_Hot_Jupiter_Model_Transmission" selected="selected">Clear Hot Jupiter Model Transmission</option>';
                /*=======================================*/
                ...
                document.getElementById('Comparison0Filters').innerHTML='<option value="Atoms_and_Molecules">Atoms and Molecules</option>';
                ...
                document.getElementById('Comparison1Filters').innerHTML='<option id="Select_Category2" value="" onclick="initialLineHdf();">Select Sub Category</option>';
                document.getElementById('Comparison1Filters').innerHTML+='<option id="Sodium_Absorption_Category2" value="Sodium_Absorption">Sodium Absorption</option>';
                document.getElementById('Comparison1Filters').innerHTML+='<option id="Potassium_Absorption_Category2" value="Potassium_Absorption">Potassium Absorption</option>';
                document.getElementById('Comparison1Filters').innerHTML+='<option id="Water_Vapor_Absorption_Category2" value="Water_Vapor_Absorption">Water Vapor Absorption</option>';
                /*=======================================*/                
                /*=======================================*/
                /*       configure PopUp position        */
                /*=======================================*/
          ...
          case "fourth":                
               ...
               document.getElementById("Tutorial_text_p").innerHTML = Tutorial_text04;
                ...
                document.getElementById('Comparison0Filters').innerHTML='<option value="Exoplanet_Models">Exoplanet Models</option>';
                SelectTarget('Cloudy_Hot_Jupiter_Model_Transmission','Targets2');
                SelectTarget('Cloudy_Hot_Jupiter_Model_Transmission','Targets2');
        ...
        if(Num==1)
            {
                ...
                document.getElementById('Targets0Filters').innerHTML='<option value="Exoplanets">Exoplanets</option>';
