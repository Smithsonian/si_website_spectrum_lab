	...
	if (ListNum=='Targets1')
		{
            ...
            readTextFile("includes/SpecLab_Data_Files/"+Targets1_folder+"/"+targetName+".txt",ListNum,Targets_Full_descriptions);
            document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/"+Targets1_folder+"/"+targetName+".jpg";     //    UCGctx  UCG       
            plotGraph(UCGctx,UCG,UCR_Huectx,UIC_ctx);
        }
	else if (ListNum=='Targets2')
		{
            readTextFile("includes/SpecLab_Data_Files/"+Targets2_folder+"/"+targetName+".txt",ListNum,Targets_Full_descriptions);
		...
		{
            readTextFile("includes/SpecLab_Data_Files/Lamps/"+targetName+".txt",ListNum,Targets_Full_descriptions);
