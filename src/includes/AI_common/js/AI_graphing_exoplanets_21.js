...
var LampsArr0 = ["Incandescent_Bulb", "Fluorescent_Bulb", "Metal_Halide_Bulb", "Sodium_Vapor_Lamp_Low_Pressure", "Cool_White_LED", "Warm_White_LED", "LED_400nm", "LED_455nm", "LED_470nm", "LED_505nm", "LED_525nm", "LED_570nm", "LED_590nm", "LED_604nm", "LED_626nm", "LED_640nm"];
/**/
var LampsArr1 = ["Incandescent Bulb", "Fluorescent Bulb", "Metal Halide Bulb", "Vapor Lamp", "LED White (Cool)", "LED White (Warm)", "LED 400 nm", "LED 455 nm", "LED 470 nm", "LED 505 nm", "LED 525 nm", "LED 570 nm", "LED 590 nm", "LED 604 nm", "LED 626 nm", "LED 640 nm"];
/////////////////////////////////////////////////////////////////////
...
var Atoms_and_Molecules1Arr0 = ["Sodium_Absorption", "Potassium_Absorption", "Water_Vapor_Absorption"];
var Atoms_and_Molecules1Arr1 = ["Sodium Absorption", "Potassium Absorption", "Water Vapor Absorption"];
/////////////////////////////////////////////////////////////////////
var AtomsArr0 = ["Hydrogen_Emission", "Helium_Emission", "Neon_Emission", "Sodium_Absorption", "Sodium_Low_Pressure_Emission", "Potassium_Absorption", "Mercury_Emission", "Ammonia_Absorption", "Carbon_Dioxide_Absorption_Near_to_Mid_IR", "Carbon_Dioxide_Absorption_Mid_to_Far_IR", "Dry_Ice_Reflection", "Ice_Reflection", "Iron_Oxide_Rust_Reflection", "Methane_Visible_Absorption", "Methane_Near_IR_Absorption", "Oxygen_Molecules_Absorption", "Ozone_Absorption_in_UV", "Ozone_Absorption_in_IR", "Water_Vapor_Absorption"];
var AtomsArr1 = ["Hydrogen Emission", "Helium Emission", "Neon Emission", "Sodium Absorption", "Sodium (low pressure) Emission", "Potassium Absorption", "Mercury Emission", "Ammonia Absorption", "Carbon Dioxide Absorption (Near to Mid IR)", "Carbon Dioxide Absorption (Mid to Far IR)", "Dry Ice Reflection", "Ice (Water) Reflection", "Iron Oxide (Rust) Reflection", "Methane Visible Absorption", "Methane Near IR Absorption", "Oxygen (Molecular) Absorption", "Ozone Absorption (UV)", "Ozone Absorption (IR)", "Water Vapor Absorption"];
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
var Exoplanet_ModelsArr0 = ["Clear_Hot_Jupiter_Model_Transmission", "Cloudy_Hot_Jupiter_Model_Transmission", "Hazy_Hot_Jupiter_Model_Transmission"];
var Exoplanet_ModelsArr1 = ["Clear Hot Jupiter Model Transmission", "Cloudy Hot Jupiter Model Transmission", "Hazy Hot Jupiter Model Transmission"];
/////////////////////////////////////////////////////////////////////
var ExoplanetsArr0 = [ "WASP_17b", "WASP_39b", "HD189733b", "HAT_P_12b", "WASP_121b", "HD209458b", "WASP_12b","K2_18b"];
var ExoplanetsArr1 = ["WASP-17b", "WASP-39b", "HD 189733b", "HAT-P-12b", "WASP-121b", "HD 209458b", "WASP-12b", "K2-18b"];
/////////////////////////////////////////////////////////////////////
var Thermal_SpectraArr0 = ["230K_blackbody", "312K_blackbody", "450K_blackbody", "1200K_blackbody", "1500K_blackbody", "2500K_blackbody", "3000K_blackbody", "4000K_blackbody", "5800K_blackbody", "7000K_blackbody", "9000K_blackbody", "11400K_blackbody", "15000K_blackbody", "30000K_blackbody"];
var Thermal_SpectraArr1 = ["230 K Blackbody", "312 K Blackbody", "450 K Blackbody", "1,200 K Blackbody", "1,500 K Blackbody", "2,500 K Blackbody", "3,000 K Blackbody", "4,000 K Blackbody", "5,800 K Blackbody", "7,000 K Blackbody", "9,000 K Blackbody", "11,400 K Blackbody", "15,000 K Blackbody", "30,000 K Blackbody"];
/////////////////////////////////////////////////////////////////////
var Solar_SystemArr0 = ["Earth_Reflection", "Earth_Emission", "Earth_Transmission","Venus_Reflection", "Venus_Emission", "Mars_Reflection", "Mars_Emission", "Jupiter_Reflection", "Europa_Reflection", "Saturn_Reflection", "Saturn_Rings_Reflection", "Titan_Reflection", "Uranus_Reflection", "Neptune_Reflection"];
var Solar_SystemArr1 = ["Earth Reflection", "Earth Emission", "Earth Transmission","Venus Reflection", "Venus Emission", "Mars Reflection", "Mars Emission", "Jupiter Reflection", "Europa Reflection", "Saturn Reflection", "Saturn Rings Reflection", "Titan Reflection", "Uranus Reflection", "Neptune Reflection"];
/////////////////////////////////////////////////////////////////////
...
function SeacrhFor(val,obj)
{
	...
	if(val=='Lamps')
		{
            ...
            if(obj=='Category1')
                {Targets1_folder ='Lamps';Targets_Titles1 =LampsArr0;Targets_descriptions1 =LampsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-medapps');
                }
            if(obj=='Category2')
                {Targets2_folder ='Lamps';Targets_Titles2 =LampsArr0;Targets_descriptions2 =LampsArr1;
	...
	else if (val=='Stars')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Stars';Targets_Titles1 =StarsArr0;Targets_descriptions1 =StarsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fa fa-globe');
                }
            if(obj=='Category2'){Targets2_folder ='Stars';Targets_Titles2 =StarsArr0;Targets_descriptions2 =StarsArr1;
                    $('#Cat2_folder').removeClass();
	...
	else if (val=='Plants')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Plants';Targets_Titles1 =PlantsArr0;Targets_descriptions1 =PlantsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fa fa-leaf');
                }
            if(obj=='Category2'){Targets2_folder ='Plants';Targets_Titles2 =PlantsArr0;Targets_descriptions2 =PlantsArr1;
                    $('#Cat2_folder').removeClass();
	...
	else if (val=='Nature')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Nature';Targets_Titles1 =NatureArr0;Targets_descriptions1 =NatureArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fa fa-leaf');}
            if(obj=='Category2'){Targets2_folder ='Nature';Targets_Titles2 =NatureArr0;Targets_descriptions2 =NatureArr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fa fa-leaf');}
		}
	else if (val=='Atoms_and_Molecules')
		{
			...
			$('#Cat2_folder').removeClass("fas fa-search");
			$('#Cat2_folder').removeClass("fa fa-globe");
			$('#Cat2_folder').removeClass("fas fa-sun");
            if(obj=='Category1'){Targets1_folder ='Atoms_and_Molecules';Targets_Titles1 =AtomsArr0;Targets_descriptions1 =AtomsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-react');}
            if(obj=='Category2'){Targets2_folder ='Atoms_and_Molecules';Targets_Titles2 =AtomsArr0;Targets_descriptions2 =AtomsArr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fab fa-react');}
		}
	else if (val=='Atoms_and_Molecules1')
		{
			$('#Cat2_folder').addClass("fab fa-react");
			$('#Cat2_folder').removeClass("fas fa-search");
			$('#Cat2_folder').removeClass("fa fa-globe");
			$('#Cat2_folder').removeClass("fas fa-sun");
            if(obj=='Category1'){Targets1_folder ='Atoms_and_Molecules';Targets_Titles1 =Atoms_and_Molecules1Arr0;Targets_descriptions1 =Atoms_and_Molecules1Arr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-react');}
            if(obj=='Category2'){Targets2_folder ='Atoms_and_Molecules';Targets_Titles2 =Atoms_and_Molecules1Arr0;Targets_descriptions2 =Atoms_and_Molecules1Arr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fab fa-react');}
		}
	else if (val=='Planets')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Planets';Targets_Titles1 =PlanetsArr0;Targets_descriptions1 =PlanetsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-wpexplorer');}
            if(obj=='Category2'){Targets2_folder ='Planets';Targets_Titles2 =PlanetsArr0;Targets_descriptions2 =PlanetsArr1;
                    $('#Cat2_folder').removeClass();
    ...
    else if (val=='Solar_System')
		{
			...
			$('#Cat2_folder').removeClass("fas fa-search");
			$('#Cat2_folder').removeClass("fa fa-globe");
			$('#Cat2_folder').removeClass("fab fa-react");
            $('#Cat2_folder').addClass("fas");
            $('#Cat2_folder').addClass("fa-sun")
            if(obj=='Category1'){Targets1_folder ='Solar_System';Targets_Titles1 =Solar_SystemArr0;Targets_descriptions1 =Solar_SystemArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-wpexplorer');}
            if(obj=='Category2'){Targets2_folder ='Solar_System';Targets_Titles2 =Solar_SystemArr0;Targets_descriptions2 =Solar_SystemArr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fab fa-wpexplorer');}
		}
	else if (val=='Thermal_Spectra')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Thermal_Spectra';Targets_Titles1 =Thermal_SpectraArr0;Targets_descriptions1 =Thermal_SpectraArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fas fa-thermometer-three-quarters');}
            if(obj=='Category2'){Targets2_folder ='Thermal_Spectra';Targets_Titles2 =Thermal_SpectraArr0;Targets_descriptions2 =Thermal_SpectraArr1;
                    $('#Cat2_folder').removeClass();
	...
	else if (val=='Exoplanet_Models')
		{
			...
			$('#Cat2_folder').removeClass("fas fa-sun");
			$('#Cat2_folder').removeClass("fab fa-react");
            if(obj=='Category1'){Targets1_folder ='Exoplanet_Models';Targets_Titles1 =Exoplanet_ModelsArr0;Targets_descriptions1 =Exoplanet_ModelsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-wpexplorer');}
            if(obj=='Category2'){Targets2_folder ='Exoplanet_Models';Targets_Titles2 =Exoplanet_ModelsArr0;Targets_descriptions2 =Exoplanet_ModelsArr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fab fa-wpexplorer');}
		}
	else if (val=='Exoplanets')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Exoplanets';Targets_Titles1 =ExoplanetsArr0;Targets_descriptions1 =ExoplanetsArr1;
                    $('#Cat1_folder').removeClass();
                    $('#Cat1_folder').addClass('fab fa-wpexplorer');}
            if(obj=='Category2'){Targets2_folder ='Exoplanets';Targets_Titles2 =ExoplanetsArr0;Targets_descriptions2 =ExoplanetsArr1;
                    $('#Cat2_folder').removeClass();
                    $('#Cat2_folder').addClass('fab fa-wpexplorer');}
		}
	else if (val=='Tests')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Tests';Targets_Titles1 =TestsArr0;Targets_descriptions1 =TestsArr1;}
            if(obj=='Category2'){Targets2_folder ='Tests';Targets_Titles2 =TestsArr0;Targets_descriptions2 =TestsArr1;}
		}
    else if (val=='Draw')
        {
            ResetCanvas();
	...
	if(obj=='Category1')
		...
		{
            Targets_Filters = "Comparison1Filters";
            $("#Category_box2").animate({width: "35px"});
            $('#Cat2_folder').css('visibility','visible');
        }
           ...
           if(obj=='Category1')
                {
                    ...
                    for (var TF = 0; TF < T_num; TF++)
                        {
                            TargetsFilters.innerHTML+='<option id="'+Targets_Titles1[TF]+'_'+obj+'" value="'+Targets_Titles1[TF]+'">'+Targets_descriptions1[TF]+'</option>';
                        }
                }
            else if(obj=='Category2')
                {
    ...
    if(val=='Empty')
        {
            ...
            document.getElementById('Comparison1Filters').innerHTML='<option value="">Select Sub Category</option>';
        }
	////////////////////////////////////////////////////////
}
/////////////////////////////////////////////////////////////////////
...
function SelectTarget(targetName,ListNum) 
{
   ...
   var Targets_Full_descriptions=Targets_descriptions[TT]
	...
	if (ListNum=='Targets1')
		{
            //console.log("This is SelectTarget in Targets1 and the targetName(%s),ListNum(%s)",targetName,ListNum);
            ...
            if(targetName=="Earth")
                ...
                {document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/"+Targets1_folder+"/B_W_mystery_star.jpg";}
             else if(Targets1_folder=='Thermal_Spectra' || Targets1_folder=='Nature' || Targets1_folder=='Solar_System')
                {document.getElementById('UpperImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";}
             else if(Targets1_folder=="Lamps" && (targetName == "Cool_White_LED" || targetName == "Warm_White_LED" || targetName == "LED_400nm" || targetName == "LED_455nm" || targetName == "LED_470nm" || targetName == "LED_505nm" || targetName == "LED_525nm" || targetName == "LED_570nm" || targetName == "LED_590nm" || targetName == "LED_604nm" || targetName == "LED_626nm" || targetName == "LED_640nm"))
                {
                    document.getElementById('UpperImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";
                }
            else
                {document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/"+Targets1_folder+"/"+targetName+".jpg";}
        }
	else if (ListNum=='Targets2')
		{
            
            //console.log("This is SelectTarget in Targets2 and the targetName(%s),ListNum(%s)",targetName,ListNum);
            var TT =Targets_Titles2.indexOf(targetName);
            var Targets_Full_descriptions=Targets_descriptions2[TT];
            readTextFile(Targets2_folder,targetName,ListNum,Targets_Full_descriptions);
            //LCGctx    LCG
            plotGraph(LCGctx,LCG,LCR_Huectx,LIC_ctx);
            if(Targets2_folder=='Thermal_Spectra' || Targets2_folder=='Atoms_and_Molecules' || Targets2_folder=='Atoms_and_Molecules1'  || Targets2_folder=='Nature' || Targets2_folder=='Solar_System')
                {document.getElementById('LowerImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";} 
            else if(Targets2_folder=="Lamps" && (targetName == "Cool_White_LED" || targetName == "Warm_White_LED" || targetName == "LED_400nm" || targetName == "LED_455nm" || targetName == "LED_470nm" || targetName == "LED_505nm" || targetName == "LED_525nm" || targetName == "LED_570nm" || targetName == "LED_590nm" || targetName == "LED_604nm" || targetName == "LED_626nm" || targetName == "LED_640nm"))
                {
                    document.getElementById('LowerImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";
                }
            else
	...
	else if (ListNum=='Targets3')
		{
            ...
            if(targetName=='Calibrate3')
               {document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/Tests/discharge tube air180x160.jpg";}
...
///////////////////////////////////////////////////////
// General Code for BB
function readBBTextFile(TheTargets_folder,BBtargetName,plotNum,Targets_Full_descriptions)
{
    var BBFileLoction="includes/SpecLab_Data_Files/"+TheTargets_folder+"/"+BBtargetName+"BB.txt";
                    ...
                    if(uppery[i]<=1)
                        {
                            ...
                            if(PlotLine==true)//Added by Aladdin
                                {
...
function updateLine(e,WIC_ctx) 
{
    ...
    if(WL_Nanometers==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_nanometers, posx + 6, 25);
            LIC_ctx.fillText(readout_nanometers, posx + 6, 25);
        }
    else if(WL_Angstrom==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_angstrom, posx + 6, 25);
            LIC_ctx.fillText(readout_angstrom, posx + 6, 25);            
        }
    else if(WL_ElectronVolt==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_eV, posx + 6, 25);
            LIC_ctx.fillText(readout_eV, posx + 6, 25);
            
        }
    else
        {
            UIC_ctx.fillText(readout_microns, posx + 6, 25);
            LIC_ctx.fillText(readout_microns, posx + 6, 25);	
        }
    ///////////////////////////////////////////////
