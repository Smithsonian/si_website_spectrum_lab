...
/*var Thermal_SpectraArr0 = ["11400K_blackbody", "1200K_blackbody", "15000K_blackbody", "1500K_blackbody", "230K_blackbody", "2500K_blackbody", "30000K_blackbody", "3000K_blackbody", "312K_blackbody", "4000K_blackbody", "450K_blackbody", "5800K_blackbody", "7000K_blackbody", "9000K_blackbody"];*/
...
function SeacrhFor(val,obj)
{
	...
	if(val=='Lamps')
	...
	else if (val=='Fishtank_Lights')
		{
			/*Targets_Titles =Thermal_SpectraArr0;
			Targets_descriptions =Thermal_SpectraArr1;*/
            if(obj=='Category1'){Targets1_folder ='Fishtank_Lights';Targets_Titles1 =Fishtank_LightsArr0;Targets_descriptions1 =Fishtank_LightsArr1;}
            if(obj=='Category2'){Targets2_folder ='Fishtank_Lights';Targets_Titles2 =Fishtank_LightsArr0;Targets_descriptions2 =Fishtank_LightsArr1;}
		}
	else if (val=='Tests')
		{
        ...
        {
            ResetCanvas();
            document.getElementById("LowerIndicatorCanvas").style.zIndex = "-1";
            document.getElementById('myDrawCanvas').style.display='block';
            document.getElementById('LowerCanvasGraph').style.display='none';
            document.getElementById('L_R_I').style.display='none';
        }
	////////////////////////////////////////////////////////
	var Targets_Filters ='';
	if(obj=='Category1')
	...
	else if(obj=='Category2')
		{
            ...
            $("#LowerCanvasGraph").show();
            $("#L_R_I").show();
            document.getElementById("LowerIndicatorCanvas").style.zIndex = "6";
	...
	if (ListNum=='Targets1')
		{
            ...
            if(targetName=="Earth")
             ...
             else if(Targets1_folder=='Nature' && targetName=='Cactus_Reflection')
                {document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/"+Targets1_folder+"/Cactus_Reflection.jpg";}
             else if(Targets1_folder=='Nature' && targetName=='Pansy_Reflection')
                {document.getElementById('UpperImg').src="includes/SpecLab_Data_Files/"+Targets1_folder+"/Pansy_Reflection.jpg";}
	...
	else if (ListNum=='Targets2')
		{
            ...
            if(Targets1_folder=='Nature' && targetName=='Cactus_Reflection')
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/Cactus_Reflection.jpg";}
            else if(Targets1_folder=='Nature' && targetName=='Pansy_Reflection')
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/Pansy_Reflection.jpg";}
            else if(Targets2_folder=='Thermal_Spectra' || Targets2_folder=='Atoms_and_Molecules' || Targets2_folder=='Nature' || Targets2_folder=='Solar_System')
...
function DrawOn()
    {
        ...
        //REDRAW RAINBOW BACKGROUND
        LCRctx.fillStyle = "#DDDDDD";
        LCRctx.fillRect(0, 0,LCR.width, rainbowHt); // the rainbow background
        // DRAW RAINBOWS
...
function ResetCanvas()
    {
        ...
        clearCanvas(Drawing_ctx,DrawCanvas,LCRctx,LCR_Huectx);
    }
///////////////////////////////////////////////////
///////////        Plot Graph         /////////////
///////////////////////////////////////////////////
                    ...
                    if(D_loadedDX2[p]<=1)
                        {
                            ...
                            var deltaX = nextPt - lastPt;
                            ////////////////////////////////////////////////
                            LCR_Huectx.fillStyle = "#000000";
                            LCR_Huectx.globalAlpha = alphax;
                            if (D_loadedDY2[p] > yStretch)
                                 {
                                    if(!isNaN(nextPt))
                                     {
                                        LCR_Huectx.clearRect(lastPt, From_Top, 2, rainbowHt);
                                        LCR_Huectx.fillRect(lastPt, From_Top, 2, rainbowHt);
                                     }
                                 }
                            if (p == 0) 
                                {var firstDataPt = lastPt}
