    ...
    //console.log("Challenge (%s) and Section (%s)",Num,Section)
                ...
                if(Section==1)
                    {
                        ...
                        document.getElementById('Targets2Filters').innerHTML='<option value="">Metal Halide</option>';
                ...
                else if(Section==3)
                    {
                        ...
                        document.getElementById('Targets1Filters').innerHTML='<option value="">Metal Halide Bulb</option>';
                        SelectTarget('Metal_Halide_Bulb','Targets1');
                ...
                else if(Section==4)
                    {
                        ...
                        SeacrhFor('Lamps','Category1');
                        document.getElementById("Category_box3").innerHTML ="<i class=\"fab fa-medapps\" id=\"Cat1_Lamps\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Lamps\"></i>";
                        document.getElementById('Targets1Filters').innerHTML='<option value="">Vapor Lamp</option>';
                ...
                if(Section==1)
                    {
                        ...
                        document.getElementById("Category_box3").innerHTML ="<i class=\"fab fa-react\" id=\"Cat1_Atoms_and_Molecules\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Atoms_and_Molecules\"></i>";
                        document.getElementById('Targets1Filters').innerHTML='<option value="">Hydrogen Emission</option>';
                        //////////////////////////////////////////////////////
                        SeacrhFor('Atoms_and_Molecules','Category2');                
                        document.getElementById("Category_box4").innerHTML ="<i class=\"fab fa-react\" id=\"Cat1_Atoms_and_Molecules\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Atoms_and_Molecules\"></i>";
                        document.getElementById('Targets2Filters').innerHTML='<option value="">Comparison spectrum</option>';
                        //////////////////////////////////////////////////////
                        SelectTarget('Hydrogen_Emission','Targets1');
                        SelectTarget('Hydrogen_Absorption','Targets2');
                        SelectTarget('Hydrogen_Emission','Targets1');
                        SelectTarget('Hydrogen_Absorption','Targets2');
                        document.getElementById("Comparison_Name").innerHTML ="Comparison spectrum";
                        //////////////////////////////////////////////////////Hydrogen Emission
                        $('#All_Tools_And_Controls').css('visibility','visible');
                        $('#All_Tools_And_Controls').css('display','block');
                        $('#LowerGraphRow').css('visibility','visible');
                ...
                else if(Section==3)
                    {
                        ...
                        //////////////////////////////////////////////////////
                         document.getElementById("Category_box3").innerHTML ="<i class=\"fas fa-sun\" id=\"Cat1_Stars\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Stars\"></i>";
                        ...
                        document.getElementById('Targets2Filters').innerHTML+='<option id="Helium_Emission_Category2" value="Helium_Emission">Helium Emission</option>';
                        document.getElementById('Targets2Filters').innerHTML+='<option id="Neon_Emission_Category2" value="Neon_Emission">Neon Emission</option>';
                        document.getElementById('Targets2Filters').innerHTML+='<option id="Calcium_Emission_Category2" value="Calcium_Emission">Calcium Emission</option>';
                        document.getElementById('Targets2Filters').innerHTML+='<option id="Iron_Emission_Category2" value="Iron_Emission">Iron Emission</option>';
                        document.getElementById('Targets2Filters').innerHTML+='<option id="Mercury_Emission_Category2" value="Mercury_Emission">Mercury Emission</option>';
                        //////////////////////////////////////////////////////
                        //////////////////////////////////////////////////////
        ...
        /*=======================================*/
        else if(Num==3)
            {
                ...
                document.getElementById('Targets1Filters').innerHTML+='<option id="Earth_Reflection_Category1" value="Earth_Reflection">Earth Reflection</option>';
                document.getElementById('Targets1Filters').innerHTML+='<option id="Earth_Emission_Category1" value="Earth_Emission">Earth Emission</option>';
                document.getElementById('Targets1Filters').innerHTML+='<option id="Earth_Transmission_Category1" value="Earth_Transmission">Earth Transmission</option>';
                /*=======================================*/
                SeacrhFor('Atoms_and_Molecules','Category2');
                document.getElementById("Category_box4").innerHTML ="<i class=\"fab fa-react\" id=\"Cat1_Atoms_and_Molecules\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Atoms_and_Molecules\"></i>";
                document.getElementById('Targets2Filters').innerHTML='<option value="">Select Sub Category</option>';
                /*document.getElementById('Targets2Filters').innerHTML+='<option id="Neon_Emission_Category2" value="Neon_Emission">Neon Emission</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Mercury_Emission_Category2" value="Mercury_Emission">Mercury Emission</option>';*/
                document.getElementById('Targets2Filters').innerHTML+='<option id="Ammonia_Absorption_Category2" value="Ammonia_Absorption">Ammonia Absorption</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Carbon_Dioxide_Absorption_Near_to_Mid_IR_Category2" value="Carbon_Dioxide_Absorption_Near_to_Mid_IR">Carbon Dioxide Absorption (Near to Mid IR)</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Carbon_Dioxide_Absorption_Mid_to_Far_IR_Category2" value="Carbon_Dioxide_Absorption_Mid_to_Far_IR">Carbon Dioxide Absorption (Mid to Far IR)</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Oxygen_Molecules_Absorption_Category2" value="Oxygen_Molecules_Absorption">Molecular oxygen absorption</option>';
               /* document.getElementById('Targets2Filters').innerHTML+='<option id="Ozone_Absorption_in_UV_Category2" value="Ozone_Absorption_in_UV">Ozone Absorption (UV)</option>';*/
                document.getElementById('Targets2Filters').innerHTML+='<option id="Ozone_Absorption_in_IR_Category2" value="Ozone_Absorption_in_IR">Ozone Absorption (IR)</option>';
        ...
        /*=======================================*/
        else if(Num==4)
            {
                ...
                document.getElementById('Targets2Filters').innerHTML+='<option id="Carbon_Dioxide_Absorption_Near_to_Mid_IR_Category2" value="Carbon_Dioxide_Absorption_Near_to_Mid_IR">Carbon Dioxide Absorption (Near to Mid IR)</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Carbon_Dioxide_Absorption_Mid_to_Far_IR_Category2" value="Carbon_Dioxide_Absorption_Mid_to_Far_IR">Carbon Dioxide Absorption (Mid to Far IR)</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Dry_Ice_Reflection_Category2" value="Dry_Ice_Reflection">Dry Ice Reflection</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Methane_Visible_Absorption_Category2" value="Methane_Visible_Absorption">Methane Visible Absorption</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Methane_Near_IR_Absorption_Category2" value="Methane_Near_IR_Absorption">Methane Near IR Absorption</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Oxygen_Molecules_Absorption_Category2" value="Oxygen_Molecules_Absorption">Molecular oxygen absorption</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Ozone_Absorption_in_IR_Category2" value="Ozone_Absorption_in_IR">Ozone Absorption (IR)</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Iron_Oxide_Rust_Reflection_Category2" value="Iron_Oxide_Rust_Reflection">Iron Oxide (Rust) Reflection</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Water_Vapor_Absorption_Category2" value="Water_Vapor_Absorption">Water Vapor Absorption</option>';
                document.getElementById('Targets2Filters').innerHTML+='<option id="Ice_Reflection_Category2" value="Ice_Reflection">Ice (Water) Reflection</option>';
