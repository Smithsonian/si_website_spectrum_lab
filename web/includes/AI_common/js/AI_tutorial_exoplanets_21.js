...
var Tutorial_text01 =
  "This is a high-resolution <strong><i>model</i></strong> of the predicted transmission spectrum from a cloud-free “Hot Jupiter” exoplanet.<br/><br/>It is based on what astronomers know about planetary atmospheres and the physics and chemistry of atoms and molecules at the temperatures and pressures found in these planets.";
var Tutorial_text02 =
  "Sodium Vapor (Na), Potassium Vapor (K), and Water Vapor (H2O) are predicted to be prominent features of <strong>Clear</strong> Hot Jupiter atmospheres in the Visible and Near Infrared regions of the spectrum.<br/><br/>(The ability to detect the presence of water in distant solar systems is important to the ultimate search for signs of life in smaller, more hospitable worlds)";
var Tutorial_text03 = "Text3";
var Tutorial_text04 =
  "Different atmospheric conditions -- such as <strong>Clouds</strong> -- can change how individual spectral signatures appear, including the <strong>width</strong> and <strong>depth</strong> of specific absorption features";
var Tutorial_text05 =
  "Different atmospheric conditions can also change the overall <strong>shape</strong> and <strong>slope</strong> of the spectrum plot.<br/>(<strong>Clouds</strong> - opaque masses of condensed liquid or ice particles - block and scatter Visible and IR light equally, flattening out the spectrum.)";
var Tutorial_text06 =
  "Different atmospheric conditions change the overall<br/><strong>shape</strong> and <strong>slope</strong> of the spectrum plot.<br/>(<strong>Hazes</strong> - small suspended particles created by UV starlight - scatter shorter wavelengths away from the line of sight and allow longer wavelengths through.)";
var Tutorial_text07 =
  "<strong>Hazes</strong> also significantly dampen and obscure the expected deep absorption features";
/////////////////////////////////////////////////////////////////////
...
function initial_tutorial() {
  ...
  /*           Change the text             */
  /*=======================================*/
  document.getElementById("UpperGraphImageHolder").src =
    "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_NoLabels_W650.png";
  document.getElementById("UpperImg").src =
    "includes/AI_common/images/Clear_Hot_Jupiter_Model_Transmission.jpg";
  ...
  $("#Clear_Hot_Jupiter_Model_Transmission_Category1").attr(
    "selected",
    "selected",
  );
  /*=======================================*/
  ...
  switch (Choice) {
    case "first":
      ...
      document.getElementById("Targets1Filters").innerHTML =
        '<option id="Clear_Hot_Jupiter_Model_Transmission_Category1" value="Clear_Hot_Jupiter_Model_Transmission" selected="selected">Clear Hot Jupiter Model Transmission</option>';
      /*=======================================*/
      /*    configure the active section       */
      /*=======================================*/
      $("#Tutorial_arrow_up").css("visibility", "visible");
      ...
      $("#Tutorial_PopUp").animate({ left: "70px" }, 500, function () {});
    ...
    case "second":
      ...
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_Labels_W650.png";
      document.getElementById("Intro_Challenge_img0").src =
        "includes/AI_common/images/Clear_Hot_Jupiter_W500.png";
      /*=======================================*/
      /*        configure the bottons          */
      /*=======================================*/
    ...
    case "third":
      ...
      document.getElementById("Targets0Filters").innerHTML =
      ...
      document.getElementById("Comparison0Filters").innerHTML =
      ...
      document.getElementById("Comparison1Filters").innerHTML =
        '<option id="Select_Category2" value="" onclick="initialLineHdf();">Select Sub Category</option>';
      document.getElementById("Comparison1Filters").innerHTML +=
        '<option id="Sodium_Absorption_Category2" value="Sodium_Absorption">Sodium Absorption</option>';
      document.getElementById("Comparison1Filters").innerHTML +=
        '<option id="Potassium_Absorption_Category2" value="Potassium_Absorption">Potassium Absorption</option>';
      document.getElementById("Comparison1Filters").innerHTML +=
    ...
    case "fourth":
      ...
      $("#Control_row_measurement_units").addClass("disabledbutton");
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_Vertical_Horiz_Lines_W650.png";
      document.getElementById("LowerGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Cloudy_Hot_Jupiter_Model_VerticalHoriz_Lines_W650.png";
      document.getElementById("Tutorial_text_p").innerHTML = Tutorial_text04;

      /*=======================================*/
      document.getElementById("Category_box4").innerHTML =
        '<i class="fa fa-globe" id="Cat1_search" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Exoplanet_Models"></i>';
      SeacrhFor("Exoplanet_Models", "Category2");
      document.getElementById("Comparison0Filters").innerHTML =
        '<option value="Exoplanet_Models">Exoplanet Models</option>';
      SelectTarget("Cloudy_Hot_Jupiter_Model_Transmission", "Targets2");
      SelectTarget("Cloudy_Hot_Jupiter_Model_Transmission", "Targets2");
      $("#Cloudy_Hot_Jupiter_Model_Transmission_Category2").attr(
        "selected",
        "selected",
      );
      $("#UpperGraphImageDiv").css("visibility", "visible");
      ...
      $("#Tutorial_PopUp").animate({ left: "90px" }, 500, function () {});
    ...
    case "fifth":
      ...
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_W650.png";
      document.getElementById("LowerGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Cloudy_Hot_Jupiter_Model_W650.png";
      $("#Tutorial_arrow_up").css("visibility", "visible");
      ...
      $("#Tutorial_PopUp").animate({ left: "75px" }, 500, function () {});
      $("#Tutorial_PopUp").animate({ top: "80px" }, 500, function () {});
      /*=======================================*/
      break;
    case "sixth":
      ...
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_W650.png";
      document.getElementById("LowerGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Hazy_Hot_Jupiter_Model_W650.png";
      //
      SelectTarget("Hazy_Hot_Jupiter_Model_Transmission", "Targets2");
      SelectTarget("Hazy_Hot_Jupiter_Model_Transmission", "Targets2");
      $("#Hazy_Hot_Jupiter_Model_Transmission_Category2").attr(
        "selected",
        "selected",
      );
    ...
    case "seveth":
      ...
      document.getElementById("LowerGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Hazy_Hot_Jupiter_Model_NoLabels_W650.png";
      //
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_NoLabels_W650.png";
...
function PrevSlide(Choice, pick) {
  ...
  switch (Choice) {
    case "first":
      document.getElementById("Tutorial_text_p").innerHTML = Tutorial_text01;
      document.getElementById("Intro_Challenge_img0").src =
        "includes/AI_common/images/HazyHotJupiter_W500.png";
      document.getElementById("UpperGraphImageHolder").src =
        "includes/AI_common/images/Exoplanets_Clear_Hot_Jupiter_Model_NoLabels_W650.png";
      /*=======================================*/
      /*    configure the active section       */
...
function ShowChallenge(Num, Section) {
  ...
  if (Num == 1) {
    ...
    /*=======================================*/
    $("#Cat2_Atoms_and_Molecules").attr(
      "onclick",
      "SeacrhFor('Atoms_and_Molecules1','Category2')",
    );
    /*=======================================*/
    ...
    SelectTarget("Clear_Hot_Jupiter_Model_Transmission", "Targets2");
    $("#Clear_Hot_Jupiter_Model_Transmission_Category2").attr(
      "selected",
      "selected",
    );
    /*=======================================*/
