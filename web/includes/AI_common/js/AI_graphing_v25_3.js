...
var LampsArr1 = ["Lamp1: Metal Halide", "Lamp2: fluorescent light", "Lamp3: sodium low pressure", "Lamp4: Incandescent bulb", "Lamp5: mercury vapor", "Lamp6: Warm white LED", "Lamp7: Cool white LED", "Blue LED", "Red LED", "Green LED", "White pixels on a computer screen"];	
/////////////////////////////////////////////////////////////////////
var StarsArr0 = ["O_Star", "B_Star", "A_Star", "F_Star", "G_Star", "K_Star", "M_Star", "Sun"];
...
var AtomsArr1 = ["Hydrogen", "Helium", "Mercury", "Nitrogen or other gas tubes"];	
/////////////////////////////////////////////////////////////////////
...
var Thermal_SpectraArr1 = ["11400K_blackbody", "1200K_blackbody", "15000K_blackbody", "1500K_blackbody", "230K_blackbody", "2500K_blackbody", "30000K_blackbody", "3000K_blackbody", "312K_blackbody", "4000K_blackbody", "450K_blackbody", "5800K_blackbody", "7000K_blackbody", "9000K_blackbody"];
/////////////////////////////////////////////////////////////////////
...
function initialLineHdf() 
    {
        xStretch = XAxis_slider.value / 55;
	...
	if(Targets_Filters!='')
	   {
			...
			for (var TF = 0; TF < T_num; TF++)
				{
					TargetsFilters.innerHTML+='<option value="'+Targets_Titles[TF]+'">'+Targets_descriptions[TF]+'</option>';
				}
		}
	////////////////////////////////////////////////////////
}
   ...
   var Targets_Full_descriptions=Targets_descriptions[TT]
	...
	if (ListNum=='Targets1')
	...
	else if (ListNum=='Targets2')
		{
            ...
            //LCGctx    LCG
            plotGraph(LCGctx,LCG,LCR_Huectx,LIC_ctx);
            if(Targets2_folder=='Thermal_Spectra')
                {document.getElementById('UpperImg').src="includes/AI_common/images/Harry_sun_spectrum.jpg";}
            else
