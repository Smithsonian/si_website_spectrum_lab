                ...
                if(Num==5)
                    {
                        ...
                        $('#LowerGraphRow').css('visibility','visible');
                        $('#boxpopup1').css('visibility','visible');
...
function NextSlide4(Choice,pick) 
	{
        switch(Choice){
          case "spectrum_image":
                document.getElementById("Tutorial4_text_p").innerHTML = 'The spectrum image and spectrum graph of your comparison object will appear here. How does it compare to the spectrum image and graph above?';
                /*=======================================*/
                /*        configure the bottons          */
                /*=======================================*/
          ...
          break;
          case "icon":
                document.getElementById("Tutorial4_text_p").innerHTML = 'Sometimes this icon will appear as a button, and you can choose a different category of comparison objects. Not for this challenge though.';
                /*=======================================*/
                /*        configure the bottons          */
                /*=======================================*/
                $('#Tutorial4_btns').css('padding-right','0px');
                $("#Tutorial4_backbtn").attr("onclick","PrevSlide4('spectrum_image','pick')");
                $("#Tutorial4_nextbtn").attr("onclick","closeInstructions4('boxpopup4')");
                $('#Tutorial4_backbtn').css('visibility','visible');
...
function PrevSlide4(Choice,pick) 
	{
        switch(Choice){
          case "dropdown":
                document.getElementById("Tutorial4_text_p").innerHTML = 'Time to use the Comparison Object panel. You can select different objects from this dropdown to compare their spectra with your spectra above.';
                /*=======================================*/
                /*        configure the bottons          */
                /*=======================================*/
                $('#Tutorial4_btns').css('padding-right','90px');
                $("#Tutorial4_nextbtn").attr("onclick","NextSlide4('spectrum_image','pick')");
...
function NextSlide(Choice,pick) 
	{
		...
		switch(Choice){
          ...
          case "challenge":
                ...
                $('#Tutorial_PopUp').animate({'top':'235px'}, 500, function() {});
                /*=======================================*/
          break;
	...
	$(function($) {
		$(document).ready(function() {
			...
			$('#Tutorial_PopUp').animate({'left':'500%'}, 500, function() {
                ...
                $('#four').removeClass("Tutorial_activeRounded");
                $('#intro_icon').removeClass("Tutorial_activeSection");
                $('#challenge_btn').removeClass("Tutorial_activeSection");
