...
/*
"Incandescent Bulb", "Fluorescent Bulb", "Metal Halide Bulb", "Sodium Vapor Lamp (Low Pressure)", "LED White (Cool)", "LED White (Warm)", "LED 400 nm", "LED 455 nm", "LED 470 nm", "LED 505 nm", "LED 525 nm", "LED 570 nm", "LED 590 nm", "LED 604 nm", "LED 626 nm", "LED 640 nm"
*/
	...
	if(val=='Lamps')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Lamps';}
            if(obj=='Category2'){Targets2_folder ='Lamps';}
	...
	else if (val=='Stars')
		{
            ...
            if(obj=='Category1'){Targets1_folder ='Stars';}
            if(obj=='Category2'){Targets2_folder ='Stars';}
		}
	else if (val=='Plants')
		{
			Targets_Titles =PlantsArr0;
			Targets_descriptions =PlantsArr1;
            if(obj=='Category1'){Targets1_folder ='Plants';}
            if(obj=='Category2'){Targets2_folder ='Plants';}
		}
	else if (val=='Atoms_and_Molecules')
		{
			Targets_Titles =AtomsArr0;
			Targets_descriptions =AtomsArr1;
            if(obj=='Category1'){Targets1_folder ='Atoms_and_Molecules';}
            if(obj=='Category2'){Targets2_folder ='Atoms_and_Molecules';}
		}
	else if (val=='Planets')
		{
			Targets_Titles =PlanetsArr0;
			Targets_descriptions =PlanetsArr1;
            if(obj=='Category1'){Targets1_folder ='Planets';}
            if(obj=='Category2'){Targets2_folder ='Planets';}
		}
	else if (val=='Thermal_Spectra')
		{
			Targets_Titles =Thermal_SpectraArr0;
			Targets_descriptions =Thermal_SpectraArr1;
            if(obj=='Category1'){Targets1_folder ='Thermal_Spectra';}
            if(obj=='Category2'){Targets2_folder ='Thermal_Spectra';}
		}
	else if (val=='Tests')
		{
			Targets_Titles =TestsArr0;
			Targets_descriptions =TestsArr1;
            if(obj=='Category1'){Targets1_folder ='Tests';}
            if(obj=='Category2'){Targets2_folder ='Tests';}
		}
    else if (val=='Draw')
        {
            ResetCanvas();
	...
	if(Targets_Filters!='')
	   {
			...
			for (var TF = 0; TF < T_num; TF++)
				{
					TargetsFilters.innerHTML+='<option id="'+Targets_Titles[TF]+'_'+obj+'" value="'+Targets_Titles[TF]+'">'+Targets_descriptions[TF]+'</option>';
				}
		}
    if(val=='Empty')
        {
	...
	if (ListNum=='Targets1')
		{
            ...
            if(targetName=="Earth")
             ...
             else if(Targets1_folder=='Thermal_Spectra')
	...
	else if (ListNum=='Targets2')
		{
            ...
            //LCGctx    LCG
            plotGraph(LCGctx,LCG,LCR_Huectx,LIC_ctx);
            if(Targets2_folder=='Thermal_Spectra' || Targets2_folder=='Atoms_and_Molecules')
