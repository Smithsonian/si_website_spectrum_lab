...
function updateLine(e,WIC_ctx) 
{
    ...
    if(WL_Nanometers==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_nanometers, posx + 6, 122);
            LIC_ctx.fillText(readout_nanometers, posx + 6, 122);
        }
    else if(WL_Angstrom==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_angstrom, posx + 6, 122);
            LIC_ctx.fillText(readout_angstrom, posx + 6, 122);            
        }
    else if(WL_ElectronVolt==true)//Added by Aladdin
        {
            UIC_ctx.fillText(readout_eV, posx + 6, 122);
            LIC_ctx.fillText(readout_eV, posx + 6, 122);
            
        }
    else
        {
            UIC_ctx.fillText(readout_microns, posx + 6, 122);
            LIC_ctx.fillText(readout_microns, posx + 6, 122);	
        }
    ///////////////////////////////////////////////
