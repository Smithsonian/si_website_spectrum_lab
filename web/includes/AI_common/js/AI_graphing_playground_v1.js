	...
	if (ListNum=='Targets1')
		{
            ...
            if(targetName=="Earth")
             ...
             else if(Targets1_folder=='Thermal_Spectra' || Targets1_folder=='Nature' || Targets1_folder=='Solar_System' || Targets1_folder=='Atoms_and_Molecules')
	...
	else if (ListNum=='Targets2')
		{
            ...
            plotGraph(LCGctx,LCG,LCR_Huectx,LIC_ctx);
            if(targetName=="Earth")
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/"+targetName+".gif";}
            else if(Targets2_folder=="Stars")
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/B_W_mystery_star.jpg";}
             else if(Targets2_folder=='Nature' && targetName=='Cactus_Reflection')
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/Cactus_Reflection.jpg";}
             else if(Targets2_folder=='Nature' && targetName=='Pansy_Reflection')
                {document.getElementById('LowerImg').src="includes/SpecLab_Data_Files/"+Targets2_folder+"/Pansy_Reflection.jpg";}
             else if(Targets2_folder=='Thermal_Spectra' || Targets2_folder=='Nature' || Targets2_folder=='Solar_System' || Targets2_folder=='Atoms_and_Molecules')
    ...
    rawFile.onreadystatechange = function ()
    {
        if(rawFile.readyState === 4)
        {
            if(rawFile.status === 200 || rawFile.status == 0)
            {
                ...
                let [x, y] = utils.parseText(allText);
