  ...
  if (Num == 1) {
    ...
    if (Section == 0) {
      ...
      document.getElementById("Category_box4").innerHTML =
        '<i class="fas fa-search" id="Cat3_search" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="search"></i>';
      ...
      document.getElementById("Type_Of_Star").innerHTML =
        "a different type of star (an M star—but again, don’t worry about what the letter means).";
    ...
    if (Section == 1) {
      ...
      document.getElementById("LowerImg").src =
        "includes/AI_common/images/Harry_sun_spectrum.jpg";
      document.getElementById("Targets1Filters").innerHTML =
        '<option value="">Vaper Lamp</option>';
      $("#Challenge4_Text1").css("display", "none");
      $("#Challenge4_Text2").css("visibility", "hidden");
      $("#Challenge4_Text2").css("display", "none");
    ...
    if (Section == 1) {
      ...
      SeacrhFor("Thermal_Spectra", "Category2");
      document.getElementById("Category_box4").innerHTML =
        '<i class="fas fa-thermometer-three-quarters" id="Cat1_Thermal_Spectra" data-toggle="tooltip" data-placement="bottom" title="Thermal_Spectra"></i>';
