...
var Atoms_and_Molecules1Arr0 = [
  "Sodium_Absorption",
  "Potassium_Absorption",
  "Water_Vapor_Absorption",
];
var Atoms_and_Molecules1Arr1 = [
  "Sodium Absorption",
...
function SeacrhFor(val, obj) {
  if (val == "Lamps") {
    ...
    if (obj == "Category1") {
      Targets1_folder = "Atoms_and_Molecules";
      Targets_Titles1 = Atoms_and_Molecules1Arr0;
      Targets_descriptions1 = Atoms_and_Molecules1Arr1;
      $("#Cat1_folder").removeClass();
      $("#Cat1_folder").addClass("fab fa-react");
    }
    if (obj == "Category2") {
      Targets2_folder = "Atoms_and_Molecules";
      Targets_Titles2 = Atoms_and_Molecules1Arr0;
      Targets_descriptions2 = Atoms_and_Molecules1Arr1;
      $("#Cat2_folder").removeClass();
      $("#Cat2_folder").addClass("fab fa-react");
    }
  } else if (val == "Planets") {
...
function SelectTarget(targetName, ListNum) {
  ...
  if (ListNum == "Targets1") {
    ...
    if (
      Targets2_folder == "Thermal_Spectra" ||
      Targets2_folder == "Atoms_and_Molecules" ||
      Targets2_folder == "Atoms_and_Molecules1" ||
      Targets2_folder == "Nature" ||
      Targets2_folder == "Solar_System"
    ) {
