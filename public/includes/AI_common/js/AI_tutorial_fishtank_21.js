...
function ShowChallenge(Num, Section) {
  ...
  if (Num == 1) {
    ...
    document.getElementById("Targets1Filters").innerHTML =
      '<option value="">Tree in Summer Reflection</option>';
    SelectTarget("Tree_in_Summer_Reflection", "Targets1");
    ...
    document.getElementById("Category_box3").innerHTML =
      '<i class="fa fa-leaf" id="Cat1_Nature" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature"></i>';
    document.getElementById("Category_box4").innerHTML =
      '<i class="fa fa-leaf" id="Cat2_Nature" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature"></i>';
    ...
    document.getElementById("Category_box3").innerHTML =
      '<i class="fa fa-leaf" id="Cat2_Nature" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature"></i>';
    document.getElementById("Targets1Filters").innerHTML =
      '<option value="">Cactus Reflection</option>';
    SelectTarget("Cactus_Reflection", "Targets1");
    /*=======================================*/
    document.getElementById("Category_box4").innerHTML =
      '<i class="fa fa-leaf" id="Cat2_Nature" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Nature"></i>';
    ...
    document.getElementById("Targets2Filters").innerHTML =
      '<option value="">Pansy Reflection</option>';
    SelectTarget("Pansy_Reflection", "Targets2");
    /*=======================================*/
    /*=======================================*/
    ...
    /*=======================================*/
    document.getElementById("Category_box3").innerHTML =
      '<i class="fas fa-fish" id="Cat3_fish" data-toggle="tooltip" data-placement="bottom" title="Fish Tank"></i>';
    /*=======================================*/
    document.getElementById("Target_Name").innerHTML = "";
    document.getElementById("Comparison_Name").innerHTML = "";
    document.getElementById("UpperImg").src =
