...
function ShowChallenge(Num, Section) {
  ...
  if (Num == 4) {
    ...
    document.getElementById("Targets2Filters").innerHTML =
      '<option value="">Fluorescent Bulb</option>';
...
function NextSlide(Choice, pick) {
  ...
  switch (Choice) {
    ...
    case "tutorial":
      ...
      document.getElementById("Tutorial_Challenge_text_p").innerHTML =
        Tutorial_text08;
      ...
      $("#Tutorial_Challenge_backbtn").attr(
        "onclick",
        "PrevSlide('dropdown','pick')",
      );
      $("#Tutorial_Challenge_nextbtn").attr(
        "onclick",
        "NextSlide('challenge','pick')",
      );
      document.getElementById("Tutorial_Challenge_nextbtn").innerHTML = "Next";
      $("#boxpopup_Challenge").animate({ width: "550px" }, 50, function () {});
      $("#Tutorial_Challenge_PopUp").animate(
        { left: "-4px" },
        500,
        function () {},
      );
    ...
    case "challenge":
      ...
      $("#challenge_btn").css("visibility", "visible");
      document.getElementById("Tutorial_Challenge_nextbtn").innerHTML =
        "Finish";
