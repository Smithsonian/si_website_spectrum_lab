...
var Tutorial_text05 =
  "This is the <strong>measuring tool.</strong> This tool tells you the wavelength or energy of the light at a specific part of the spectrum.";
var Tutorial_text06 =
  "This <strong>measuring tool dropdown menu</strong> lets you choose the units (in wavelength or energy) that are reported by the measuring tool.<br/>Recall from Session 2 that photons with higher energy have shorter wavelengths than photons with lower energy.";
var Tutorial_text07 =
...
function initial_tutorial() {
  ...
  document.getElementById("Category_box3").innerHTML =
    '<i class="fa fa-globe" id="Cat1_search" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Planets"></i>';
...
function ShowChallenge(Num, Section) {
  ...
  if (Num == 1) {
    ...
    if (Section == 1) {
      ...
      document.getElementById("C2P1_StarName1").innerHTML =
        "<strong><i>Sun</i></strong>";
      SeacrhFor("Stars", "Category1");
      SeacrhFor("Stars", "Category1");
      SelectTarget("sun_ref_colina96", "Targets1");
      document.getElementById("Category_box3").innerHTML =
        '<i class="fas fa-sun" id="Cat1_Stars" data-toggle="tooltip" data-placement="bottom" title="Stars" onclick="SeacrhFor(\'Stars\',\'Category1\')"></i>';
      ...
      document.getElementById("C2P1_StarType").innerHTML =
        "an <strong>M</strong> star.";
      document.getElementById("C2P1_StarName1").innerHTML =
        "<strong><i>M</i></strong> star";
      SelectTarget("M_Star", "Targets1");
      document.getElementById("Targets1Filters").innerHTML =
        '<option value="">M Star</option>';
      /////////////////////////////////////////////////
      /*$("#challenge_btn").css('width','170px');*/
      ...
      $("#C2P1_Comment1").css("display", "none");
      document.getElementById("C2P1_StarType").innerHTML =
        "a <strong>B</strong> star.";
      document.getElementById("C2P1_StarName1").innerHTML =
        "<strong><i>B</i></strong> star";
      SelectTarget("B_Star", "Targets1");
      document.getElementById("Targets1Filters").innerHTML =
        '<option value="">B Star</option>';
      /////////////////////////////////////////////////
      $("#challenge_Bbtn").css("visibility", "visible");
      ...
      document.getElementById("C2P1_StarType").innerHTML =
        "a different type of star (a B star—but again, don’t worry about what the letter means).";
      ...
      document.getElementById("Category_box4").innerHTML =
        '<i class="fas fa-thermometer-three-quarters" id="Cat1_Lamps" data-toggle="tooltip" data-placement="bottom" title="Lamps"></i>';
      //Thermal_Spectra
      document.getElementById("Targets2Filters").innerHTML =
        '<option value="">Select Sub Category</option>';
      document.getElementById("Targets2Filters").innerHTML +=
        '<option id="450K_blackbody_Category2" value="450K_blackbody">450 K Blackbody</option>';
      document.getElementById("Targets2Filters").innerHTML +=
        '<option id="2500K_blackbody_Category2" value="2500K_blackbody">2,500 K Blackbody</option>';
      document.getElementById("Targets2Filters").innerHTML +=
        '<option id="5800K_blackbody_Category2" value="5800K_blackbody">5,800 K Blackbody</option>';
      document.getElementById("Targets2Filters").innerHTML +=
        '<option id="9000K_blackbody_Category2" value="9000K_blackbody">9,000 K Blackbody</option>';
      document.getElementById("Targets2Filters").innerHTML +=
        '<option id="15000K_blackbody_Category2" value="15000K_blackbody">15,000 K Blackbody</option>';
      //////////////////////////////////////////////////////
      //////////////////////////////////////////////////////
    ...
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="450K_blackbody_Category2" value="450K_blackbody">450 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="1200K_blackbody_Category2" value="1200K_blackbody">1,200 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="2500K_blackbody_Category2" value="2500K_blackbody">2,500 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="5800K_blackbody_Category2" value="5800K_blackbody">5,800 K Blackbody</option>';
    ...
    document.getElementById("Targets1Filters").innerHTML =
      '<option value="">Earth Emission</option>';
    SelectTarget("Earth", "Targets1");
    //////////////////////////////////////////////////////
    /*=======================================*/
    document.getElementById("Comparison_Name").innerHTML = "";
    ...
    document.getElementById("Targets2Filters").innerHTML =
      '<option value="">Select Sub Category</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="230K_blackbody_Category2" value="230K_blackbody">230 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="312K_blackbody_Category2" value="312K_blackbody">312 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="450K_blackbody_Category2" value="450K_blackbody">450 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="1500K_blackbody_Category2" value="1500K_blackbody">1,500 K Blackbody</option>';
    document.getElementById("Targets2Filters").innerHTML +=
      '<option id="5800K_blackbody_Category2" value="5800K_blackbody">5,800 K Blackbody</option>';
    /*=======================================*/
