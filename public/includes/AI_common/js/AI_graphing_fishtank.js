...
function SelectTarget(targetName, ListNum) {
  ...
  if (ListNum == "Targets1") {
    console.log(
      "This is SelectTarget in Targets1 and the targetName(%s),ListNum(%s)",
      targetName,
      ListNum,
    );
    ...
    console.log(
      "This is SelectTarget in Targets2 and the targetName(%s),ListNum(%s)",
      targetName,
      ListNum,
    );
...
function readTextFile(
  ...
  var FileLoction =
    ...
    ".txt";
  console.log(
    "in Target_Name and the plotNum=(%s) Targets_Full_descriptions=(%s) fileLoction=(%s)",
    plotNum,
    Targets_Full_descriptions,
    FileLoction,
  );
